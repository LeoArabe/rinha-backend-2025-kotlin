...
class GlobalExceptionHandler {
    ...
    fun handleDuplicateKey(ex: DuplicateKeyException) =
    ...
    fun handleInvalidDateRange(ex: InvalidDateRangeException) =
    ...
    fun handlePaymentProcessing(ex: PaymentProcessingException) =
